      ...
      <body>
        ...
        <header style={{position: 'sticky', top: 0, zIndex: 40, background: 'rgba(5,5,5,.94)', borderBottom: '1px solid #252525', backdropFilter: 'blur(12px)'}}>
          <div className="shell header-inner">
            ...
            <Link className="btn btn-gold mobile-call" href="/hop">Hop Now</Link>
            <Link className="btn btn-gold navlinks" href="/hop">Hop Now</Link>
          </div>
        </header>
        {children}
